...
import { Flower, Truck, Clock, Star, Moon, Sun } from "lucide-react"
...
export default function LandingPage() {
    ...
    <div className="mr-4 hidden md:flex">
      <Link className="mr-6 flex items-center space-x-2" href="/">
        <img
          ...
          className="h-6 w-6"
        />
        <span className="hidden font-bold text-pink-700 dark:text-pink-300 sm:inline-block">
  ...
  className="ml-auto bg-pink-500 hover:bg-pink-600 text-white dark:bg-pink-600 dark:hover:bg-pink-700 px-6 py-3 rounded-lg text-sm font-medium"
>
  Pesan Sekarang
</a>
    <Button className="ml-2 p-2" variant="outline" onClick={toggleDarkMode} aria-label="Toggle dark mode">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-pink-700 dark:text-pink-300">
                    Sewa Flower Box untuk Momen Spesial Anda
                  </h1>
                  <p className="max-w-[600px] text-pink-600 dark:text-pink-400 md:text-xl">
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="flex items-center justify-center px-6 py-3 bg-pink-500 hover:bg-pink-600 text-white dark:bg-pink-600 dark:hover:bg-pink-700 rounded-lg text-base font-semibold"
  >
    Lihat Katalog
  </a>
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="flex items-center justify-center px-6 py-3 border-2 border-pink-500 text-pink-500 hover:bg-pink-100 dark:border-pink-400 dark:text-pink-400 dark:hover:bg-pink-950 rounded-lg text-base font-semibold"
  >
    Hubungi Kami
  </a>
</div>
  ...
  <div className="container mx-auto px-4 md:px-6">
    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 text-green-700 dark:text-green-300">
      Galeri Flower Box
    </h2>
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      />
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32 bg-pink-100 dark:bg-gray-800">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12 text-pink-700 dark:text-pink-300">
              Cara Pemesanan
            </h2>
